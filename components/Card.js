...
const Card = () => {
  ...
  return (
    ...
    <div className='py-14'>
      ...
      <h2 class="mb-8 lg:mb-16 text-3xl font-bold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Our Services</h2>
      <div className='flex justify-between px-3'>
        ...
        {data.map((item)=>{ 
          ...
          <div class="p-5">
            ...
            <p class="mb-3 text-sm font-normal text-gray-700 dark:text-gray-400">{item.desc}</p>
            <button href={'#'} class="inline-flex items-center text-sm font-medium text-center text-baseColor rounded-lg hover:underline">
                Read More
